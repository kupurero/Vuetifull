...
const spinner = ora("Building Vuetifull...")
spinner.start()
...
rm(path.join(config.system.assetsRoot, config.system.assetsSubDirectory), err => {
	...
	webpack(webpackConfig, (err, stats) => {
		...
		if (stats.hasErrors()) {
			console.log(chalk.red("Vuetifull build failed with errors.\n"))
			process.exit(1)
		}

		console.log(chalk.cyan("Vuetifull build complete.\n"))
		console.log(chalk.yellow(
			"Tip: You can now publish vuetifull as a private NPM module.\n" +
